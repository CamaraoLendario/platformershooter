...
public partial class WeaponPickup : Pickup
{
	...
	public int chosenWeapon
    {
        ...
        {
			ChosenWeapon = value;
			itemName = weaponNamesArray[value] + " Tome";
	...
	public override void _Ready()
	{
		...
		itemName = weaponNamesArray[ChosenWeapon] + " Tome";
		weaponSprite.Play();
		if (GetParent<Node>().Name != "Pickups" ) GD.PrintErr("WEAPON PICKUPS NODE NOT DETECTED: weapon pickups need to be placed under the weapon pickups Node");
